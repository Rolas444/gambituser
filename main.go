...
import (
	...
	"github.com/Rolas444/gambituser/awsgo"
	"github.com/Rolas444/gambituser/bd"
...
func EjecutoLambda(ctx context.Context,
	event events.CognitoEventUserPoolsPostConfirmation) (events.CognitoEventUserPoolsPostConfirmation, error) {
	awsgo.InicializoAWS()
	if !ValidoParametros() {
		fmt.Println("Error en los parametros, debe ingresar un 'SecretManager'")
